...
const List<AdminNavItem> kAdminNavItems = [
  ...
  AdminNavItem(index: 2, icon: Icons.menu_book, label: 'Courses & Curriculum'),
  AdminNavItem(index: 3, icon: Icons.groups, label: 'Student Directory'),
  AdminNavItem(index: 4, icon: Icons.security, label: 'Security Audit Logs'),
];
                ...
                Row(
                  children: [
                    const CircleAvatar(
                      ...
                      child: Icon(Icons.verified_user, size: 18, color: AppTheme.backgroundMidnight),
                    ),
          ...
          DrawerHeader(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.admin_panel_settings, color: AppTheme.primaryCyan, size: 28),
                    ),
                    const SizedBox(width: 12),
                    const Text(
                      'Root Admin Console',
                ...
                const SizedBox(height: 12),
                Text(
                  authProvider.currentUser?.email ?? 'admin@virtuanetlab.univ.edu',
